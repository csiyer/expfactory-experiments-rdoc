...
/* ************************************ */
function addID() {
  jsPsych.data.addDataToLastTrial({exp_id: 'flanker_rdoc'})
}
...
// lets call response_keys.key[0] 'H' and response_keys.key[1] 'F'
...
var instructions_block = {
	...
	pages: [
		'<div class = centerbox>'+
			'<p class=block-text>Place your <b>index finger</b> on the <i>' + response_keys.key_description[0] + '</i> key (' + response_keys.key_symbol[0] + ') and your <b>middle finger</b> on the <i>' + response_keys.key_description[1] + '</i> key (' + response_keys.key_symbol[1] + ') </p>' + 
			'<p class = block-text>On each trial, you will see a string of F\'s and H\'s. For instance, you might see \'FFFFF\' or \'HHFHH\'. </p>'+
			'<p class = block-text>If the middle letter is an <b>H</b>, press your <b>' + response_keys.key_name[0] + '</b>. <br> If the middle letter is an <b>F</b>, press your <b>' + response_keys.key_name[1] + '</b>. <br> So, if you see \'FFHFF\', you would press your <b>' + response_keys.key_name[0]  + '</b>.</p>'+
			 speed_reminder + 
...
var start_test_block = {
	...
	'<p class = block-text>Keep your index finger on the ' + response_keys.key_description[0] + ' key and your middle finger on the ' + response_keys.key_description[1] + ' key.</p>' + 
...
var feedback_text = '<p class=center-block-text>Welcome! This experiment will take around 5 minutes.</p>' +
  '<p class=center-block-text>To avoid technical issues, please keep the experiment tab (on Chrome or Firefox) active and in full-screen mode for the whole duration of each task.</p>' +
  '<p class=center-block-text> Press <i>enter</i> to begin.</p>'
var feedback_block = {
	type: 'poldrack-single-stim',
...
flanker_rdoc_experiment.push(feedback_block)
